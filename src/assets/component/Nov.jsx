...
const fetchData = async () => {
  const response = await axios.get("https://fishing-project-server.vercel.app/novProject");
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://fishing-project-server.vercel.app/novProject/${id}`)
          .then((response) => {
